...
private:
    ...
    map<unsigned long long int, StudentInterface*> gpaMap;
    set<StudentInterface*,Comparator> gpaSet;
...
public:
    ...
    int loadNumberOfLines(string fileName);
    /*
    ...
    void clear(){
        ...
        set<StudentInterface*>::iterator i;
        
        for ( i = gpaSet.begin(); i != gpaSet.end(); ++i)
            delete *i;
