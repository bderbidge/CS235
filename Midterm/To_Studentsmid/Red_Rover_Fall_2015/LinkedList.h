...
public:
    ...
    /*Searches the linked list to see if the value of the node is in the list and returns true if it is found*/
    bool search(T value){
    ...
    /*
     * Searches for the player in the linked list, once found a ptr to the player right after it is returned unless the ptr to the player after
     * it is NULL then a ptr to the player right before it is returned. Otherwise NULL is returned.
     */
    T searchForIndex(T value){
...
void insertAfter(T value, T insertionNode){
   ...
   /* while(ptr != NULL)
    ...
    if(condition == true)
    {
        ...
        Node* new_node = new Node(value, current->next, current);
